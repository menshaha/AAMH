...
--------------- Files
makefolder("MHUB")
makefolder('MHUB\\Anime Adventures')


local DefaultFiles = {

	['MHUB\\Settings_' .. player.Name] = {
...
local PortalsList = {'Alien Portal', 'Summer Portal', 'Eclipse Portal', 'Puppet Portal', 'Port Agency', "Demon Leader's Portal"}
...
autoUseAbilityUnitsTable = {'jotaro', 'eren_final', 'ainz_evolved', 'kisuke_evolved',
	...
	'jotaro_p6_evolved', 'homura_evolved', 'diavolo', 'armin', 'alucard_evolved', 'dazai_evolved', 'hidan_evolved'
